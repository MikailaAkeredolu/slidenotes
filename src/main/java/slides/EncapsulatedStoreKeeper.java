...
public class EncapsulatedStoreKeeper {

    private String name;

    EncapsulatedStoreKeeper(String name){
        setName(name);
    }
    public void manageAlbum(EncapsulatedAlbum album, String name, String artist, double price, int numberOfCopies){
         /*
